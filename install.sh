...
brew_cask=("1password" "google-chrome" "chatgpt-atlas" "iterm2" "visual-studio-code" "gitkraken" "postman" "docker" "telegram-desktop" "spotify" "raycast" "logi-options+" "notion" "notion-calendar" "notion-mail" "google-cloud-sdk" "openvpn-connect" "chatgpt" "amazon-q" "drawio" "kiro" "antigravity" "atuin-desktop") # 視窗程式
